...
// Call DfProjectXmlTest::main() if this source file is executed directly.
if (!defined("PHPUnit_MAIN_METHOD")) {
    define("PHPUnit_MAIN_METHOD", "DfProjectXmlTest::main");
}
...
require_once dirname(__FILE__).'/../../com_dfproject/dfproject.class.php';
 ...
 * @link       https://dev.hugllc.com/index.php/Project:Timeclock
 */
class DfProjectXmlTest extends JoomlaXmlTestCase
{
    /**
    ...
    {
        return self::getDataName("com_dfproject", "dfproject");    
    }
    ...
    {
        return self::getDataFiles("com_dfproject");    
    }

}

// Call DfProjectXmlTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == "DfProjectXmlTest::main") {
    DfProjectXmlTest::main();
}
