...
/**
    $Id: admin.dfprojecttimeclock.php 407 2006-12-29 21:16:20Z prices $
    @file admin.dfprojecttimeclock.php
    
    @verbatim
    Copyright 2005 Hunt Utilities Group, LLC (www.hugllc.com)
    
    admin.dfprojecttimeclock.php is part of com_dfprojecttimeclock.
...
case 'config':
    ...
    HTML_dfprojecttimeclock::showConfig($option, $df_config);
    break;
case 'configsave':
...
case 'userpref':
	...
	break;
case 'install':
	@require_once("install.dfprojecttimeclock.php");
	com_install();
default:
    HTML_dfprojecttimeclock::showAbout();
    break;   
}
