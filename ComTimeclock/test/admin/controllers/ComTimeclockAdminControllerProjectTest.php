...
require_once dirname(__FILE__).'/../../../admin/controllers/project.php';
 ...
 * @link       https://dev.hugllc.com/index.php/Project:ComTimeclock:JoomlaUI
 */
class ComTimeclockAdminControllerProjectTest extends JControllerTest
{
    /**
    ...
    {
        $this->o = new TimeclockAdminControllerProject();
        parent::setUp();
    }
    ...
    {
        return array(
            array("display", array("view" => "project")),
        );
    }
