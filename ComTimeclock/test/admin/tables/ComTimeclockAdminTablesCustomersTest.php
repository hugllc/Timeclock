...
require_once dirname(__FILE__).'/../../../admin/tables/timeclockcustomers.php';
 ...
 * @link       https://dev.hugllc.com/index.php/Project:ComTimeclock:JoomlaUI
 */
class ComTimeclockAdminTablesCustomersTest extends JTableTest
{
    /** @var string The table we should be using */
    public $table = "#__timeclock_customers";
    /** @var the Id string */
    public $id = "id";
    ...
    protected function setUp() 
    {
        ...
        parent::setUp();
        $this->_db->setQuery("DELETE FROM #__timeclock_customers");
        $this->_db->query();
        $this->o = new TableTimeclockCustomers($this->_db);
    }
    ...
    {
        return array(
            array("#__timeclock_customers", "id", null),
        );
    }
