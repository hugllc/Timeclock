...
require_once dirname(__FILE__).'/../../../admin/views/customer/view.html.php';
 ...
 * @link       https://dev.hugllc.com/index.php/Project:ComTimeclock:JoomlaUI
 */
class ComTimeclockAdminViewCustomerTest extends JViewTest
{
    /**
    ...
    protected function setUp() 
    {
        ...
        $this->o = new TimeclockAdminViewCustomer();
        parent::setUp();
    }
