...
require_once dirname(__FILE__).'/../../../admin/views/project/view.html.php';
 ...
 * @link       https://dev.hugllc.com/index.php/Project:ComTimeclock:JoomlaUI
 */
class ComTimeclockAdminViewProjectTest extends JViewTest
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->o = new TimeclockAdminViewProject();
        parent::setUp();
    }
