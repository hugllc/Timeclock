...
require_once dirname(__FILE__).'/../../../admin/views/tools/view.html.php';
 ...
 * @link       https://dev.hugllc.com/index.php/Project:ComTimeclock:JoomlaUI
 */
class ComTimeclockAdminViewToolsTest extends JViewLegacyTest
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->o = new TimeclockAdminViewTools();
        parent::setUp();
    }
