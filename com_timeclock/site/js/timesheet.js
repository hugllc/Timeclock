var Timesheet = {
    ...
    {
        jQuery.ajax({
            url: 'index.php?option=com_timeclock&task=timesheet.complete&format=json',
            type: 'GET',
            data: this._formData(),
            dataType: 'JSON',
            success: (ret) =>
    ...
    refresh: function ()
    {
        var url = 'index.php?option=com_timeclock&view=timesheet&format=json&date='+this.payperiod.start;
        jQuery.ajax({
            url,
            type: 'GET',
            data: {},
