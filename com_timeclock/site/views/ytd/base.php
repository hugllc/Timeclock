 ...
 * @link       https://dev.hugllc.com/index.php/Project:ComTimeclock
 */
class TimeclockViewsYtdBase extends JViewBase
{
    ...
    */
    protected function setup($file)
    {
        ...
        $report = Text::sprintf("COM_TIMECLOCK_YTD_REPORT_TITLE", $this->start, $this->end);
        $this->phpexcel->getProperties()->setCreator($user->name)
            ->setLastModifiedBy($user->name)
            ->setTitle($report)
            ->setSubject($report)
            ->setKeywords(Text::_("COM_TIMECLOCK_YTD_REPORT"));
        ...
        // Rename worksheet
        $this->phpexcel->getActiveSheet()->setTitle(Text::_("COM_TIMECLOCK_YTD_REPORT"));
