...
$url = JRoute::_('&option=com_timeclock&controller=payroll&date=now');
...
$url = JRoute::_('&option=com_timeclock&controller=payroll&date='.$displayData->next);
...
$text = '<img src="'.$img.'" alt="&lt;" style="border: none;" />';
$url = JRoute::_('&option=com_timeclock&controller=payroll&date='.$displayData->prev);
