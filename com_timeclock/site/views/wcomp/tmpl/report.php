...
<form action="<?php JROUTE::_("index.php?option=com_timeclock&controller=wcomp"); ?>" method="post" name="userform" class="report">
    <div class="page-header row">
        <h2 itemprop="name">
            <a id="timeclocktop"></a>
            <?php print JText::_("COM_TIMECLOCK_WCOMP_REPORT"); ?>
    ...
    <?php 
        print $this->_export->render(
            (object)array(
                "url" => JRoute::_('&option=com_timeclock&controller=wcomp'),
                "export" => $this->export,
            )
        ); 
    ?>
