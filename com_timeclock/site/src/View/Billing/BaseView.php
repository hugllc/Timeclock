...
class BaseView extends HtmlView
{
    ...
    */
    protected function row($data)
    {
        ...
        $this->phpexcel->getActiveSheet()->getStyle($rate)->getNumberFormat()->setFormatCode(NumberFormat::FORMAT_CURRENCY_USD);
        $col = $this->nextCol($col);
    ...
    */
    protected function totals($data)
    {
        ...
        $this->phpexcel->getActiveSheet()->getStyle($this->maxCol.$this->line)->getNumberFormat()->setFormatCode(NumberFormat::FORMAT_CURRENCY_USD);
        $this->line++;
    }
    /**
