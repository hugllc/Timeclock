 ...
 */
namespace HUGLLC\Component\Timeclock\Site\View\Usersum;
    ...
    */
    protected function setup($file)
    {
        ...
        $this->phpexcel->getProperties()->setCreator($user->name)
            ...
            ->setTitle($report)
            ->setSubject($report)
            ->setKeywords(Text::_("COM_TIMECLOCK_USERSUM_REPORT"));
        ...
        // Rename worksheet
        $this->phpexcel->getActiveSheet()->setTitle(Text::_("COM_TIMECLOCK_USERSUM_REPORT"));
