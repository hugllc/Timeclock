...
$url = Route::_("index.php?controller=timesheet&id=".$displayData->user->id."&date=".$displayData->payperiod->start);
$payroll = Route::_("index.php/timeclock?view=payroll&date=".$displayData->payperiod->start);
?>
...
<?php elseif (!$displayData->user->me && $this->getCurrentUser()->authorise("timeclock.timesheet.approve", "com_timeclock") && !$displayData->payperiod->locked): ?>
