 ...
 *
 */
class DepartmentsController extends DisplayController
{
    /**
     * Constructor.
     *
    ...
    public function publish() {
        ...
        $cid = $input->get("department_id");
        $task = $input->get("task");
        $this->getModel("Department")->publish($cid, ($task == "publish") ? 1 : 0);
        $this->setRedirect("index.php?option=com_timeclock&view=departments");
    }
    /**
     * Checkin entries
     */
