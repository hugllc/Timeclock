 ...
 *
 */
class ProjectsController extends DisplayController
{
    /**
     * Constructor.
     *
    ...
    public function publish() {
        ...
        $cid = $input->get("project_id");
        $task = $input->get("task");
        $this->getModel("Project")->publish($cid, ($task == "publish") ? 1 : 0);
        $this->setRedirect("index.php?option=com_timeclock&view=projects");
    }
    /**
     * Checkin entries
     */
