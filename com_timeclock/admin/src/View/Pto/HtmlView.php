 ...
 */
namespace HUGLLC\Component\Timeclock\Administrator\View\Pto;
...
class HtmlView extends BaseHtmlView
{
    ...
    */
    protected function addToolbar()
    {
        ...
        $add = empty($this->item->pto_id);
        $title = ($add) ? Text::_("COM_TIMECLOCK_ADD") : Text::_("COM_TIMECLOCK_EDIT");

        $toolbar    = Toolbar::getInstance();

        ToolbarHelper::title(
            Text::sprintf("COM_TIMECLOCK_PTO_EDIT_TITLE", $title), "clock"
        );
        $toolbar->apply('pto.apply');
        $toolbar->save('pto.save');
        $toolbar->cancel('pto.cancel', 'JTOOLBAR_CANCEL');
    }
    /**
