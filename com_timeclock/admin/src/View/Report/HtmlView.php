 ...
 */
namespace HUGLLC\Component\Timeclock\Administrator\View\Report;
...
class HtmlView extends BaseHtmlView
{
    ...
    */
    protected function addToolbar()
    {
        ...
        $add = empty($this->item->report_id);
        $title = ($add) ? Text::_("COM_TIMECLOCK_ADD") : Text::_("COM_TIMECLOCK_EDIT");

        $toolbar    = Toolbar::getInstance();

        ToolbarHelper::title(
            Text::sprintf("COM_TIMECLOCK_REPORT_EDIT_TITLE", $title), "clock"
        );
        $toolbar->apply('report.apply');
        $toolbar->save('report.save');
