...
namespace HUGLLC\Component\Timeclock\Administrator\View\Ptos;
...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        if ($this->items && !\count($this->items) && $this->isEmptyState = $this->get('IsEmptyState')) {
    ...
    protected function addToolbar()
    {
        ...
        ToolbarHelper::title(
            Text::_("COM_TIMECLOCK_TIMECLOCK_PTOS"), "clock"
        );
        if ($actions->get('core.create')) {
            ToolbarHelper::addNew('pto.add');
        }
        if ($actions->get('core.edit.state'))
        {
            ToolbarHelper::checkin('ptos.checkin');
        }
