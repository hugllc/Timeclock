...
class ProjectModel extends AdminModel
{
     ...
     * @since  3.2
     */
    public $typeAlias = 'com_timeclock.project';
    ...
    */
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_timeclock.project', 'project', ['control' => 'jform', 'load_data' => $loadData]);
        if (empty($form)) {
            return false;
        }
        return $form;
    ...
    protected function loadFormData()
    {
        ...
        $data = $app->getUserState('com_timeclock.edit.project.data', []);

        if (empty($data)) {
            $data = $this->getItem();
        }

        $this->preprocessData('com_timeclock.project', $data);
    ...
    */
    public function save($data)
    {
        ...
        if (empty($data['project_id'])) {
            $data['project_id'] = $form['project_id'] or Factory::getApplication()->getInput()->getInt("project_id") or 0;
        }
