...
class DepartmentModel extends AdminModel
{
     ...
     * @since  3.2
     */
    public $typeAlias = 'com_timeclock.department';
    ...
    */
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_timeclock.department', 'department', ['control' => 'jform', 'load_data' => $loadData]);
        if (empty($form)) {
            return false;
        }
        return $form;
    ...
    protected function loadFormData()
    {
        ...
        $data = $app->getUserState('com_timeclock.edit.department.data', []);

        if (empty($data)) {
            $data = $this->getItem();
        }

        $this->preprocessData('com_timeclock.department', $data);
