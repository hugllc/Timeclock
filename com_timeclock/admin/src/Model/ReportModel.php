...
class ReportModel extends AdminModel
{
     ...
     * @since  3.2
     */
    public $typeAlias = 'com_timeclock.report';
    ...
    */
    public function getItem($id = null)
    {
        ...
        $id = $id ? $id : Factory::getApplication()->getInput()->getInt("report_id");
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_timeclock.report', 'report', ['control' => 'jform', 'load_data' => $loadData]);
        if (empty($form)) {
            return false;
        }
        return $form;
    ...
    protected function loadFormData()
    {
        ...
        $data = $app->getUserState('com_timeclock.edit.report.data', []);

        if (empty($data)) {
            $data = $this->getItem();
        }

        $this->preprocessData('com_timeclock.report', $data);
