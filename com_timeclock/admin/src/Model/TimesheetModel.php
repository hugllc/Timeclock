 ...
 * @link       https://dev.hugllc.com/index.php/Project:ComTimeclock
 */
class TimesheetModel extends AdminModel
{
     ...
     * @since  3.2
     */
    public $typeAlias = 'com_timeclock.timesheet';
    ...
    */
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_timeclock.timesheet', 'timesheet', ['control' => 'jform', 'load_data' => $loadData]);
        if (empty($form)) {
            return false;
        }
        return $form;
    ...
    protected function loadFormData()
    {
        ...
        $data = $app->getUserState('com_timeclock.edit.timesheet.data', []);

        if (empty($data)) {
            $data = $this->getItem();
        }

        $this->preprocessData('com_timeclock.timesheet', $data);
