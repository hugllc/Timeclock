...
use HUGLLC\Component\Timeclock\Administrator\Trait\HolidayDBTrait;
...
class HolidayModel extends AdminModel
{
     ...
     * @since  3.2
     */
    public $typeAlias = 'com_timeclock.holiday';
    ...
    */
    public function getItem($id = null)
    {
        ...
        $id = $id ? $id : Factory::getApplication()->getInput()->getInt("timesheet_id");
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_timeclock.holiday', 'holiday', ['control' => 'jform', 'load_data' => $loadData]);
        if (empty($form)) {
            return false;
        }
        return $form;
    ...
    protected function loadFormData()
    {
        ...
        $data = $app->getUserState('com_timeclock.edit.holiday.data', []);

        if (empty($data)) {
            $data = $this->getItem();
        }

        $this->preprocessData('com_timeclock.holiday', $data);
    ...
    */
     ...
     */
    public function getTable($type = 'Timesheet', $prefix = 'Administrator', $config = [])
    {
