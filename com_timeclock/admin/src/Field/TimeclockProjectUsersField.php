 ...
 * @version    GIT: $Id: 0e0a42e141361ddf6a524ed6c01e281d912246ea $
...
class TimeclockProjectUsersField extends FormField
{
    ...
    */
    public function getInput()
    {
        ...
        foreach ($users as $row) {
            $displayData["outOptions"][$row->id] = HtmlHelper::_(
                'select.option', 
                (int)$row->id, 
                Text::_($row->name)
            );
        ...
        $layout = new FileLayout('dualselect', JPATH_ROOT.'/components/com_timeclock/layouts');
