            ...
            <thead>
                <tr>
                    ...
                    <th width="1%" style="min-width:55px" class="nowrap center">
                        <?php echo HTMLHelper::_('grid.sort', 'JSTATUS', 'r.published', $listDirn, $listOrder); ?>
                    </th>
                    <th>
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_NAME', 'r.name', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center">
                        <?php echo Text::_("COM_TIMECLOCK_EXPORT"); ?>
                    </th>
                    <th class="center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_TYPE', 'r.type', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', 'JAUTHOR', 'author', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_START_DATE', 'r.startDate', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_END_DATE', 'r.endDate', $listDirn, $listOrder); ?>
                    </th>
                    <th width="1%" class="nowrap center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', 'JGRID_HEADING_ID', 'r.report_id', $listDirn, $listOrder); ?>
                    </th>
                </tr>
            </thead>
