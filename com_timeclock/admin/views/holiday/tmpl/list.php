        ...
        <table id="adminTable" cellpadding="0" cellspacing="0" width="100%" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th>
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_NOTES', 'notes', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center">
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_WORK_DATE', 't.worked', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center">
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_HOURS', 'hours', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_PROJECT', 'project', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center hidden-phone">
