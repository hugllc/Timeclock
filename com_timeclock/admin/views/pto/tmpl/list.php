...
{
    if (format) {
        var url = "<?php echo str_replace("/administrator", "", Route::_('index.php?option=com_timeclock')); ?>&controller=report&report_id="+id+"&format="+format;
        if (format == "ehtml") {
            url = url + "&inline=1";
            console.log(url);
...
<form action="<?php echo Route::_('index.php?option=com_timeclock'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <div id="j-main-container" class="span10">
        ...
        <table id="adminTable" cellpadding="0" cellspacing="0" width="100%" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th>
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_NAME', 'u.name', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_HOURS', 'o.hours', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_TYPE', 'o.type', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', 'JAUTHOR', 'author', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_VALID_FROM', 'o.valid_from', $listDirn, $listOrder); ?>
                    </th>
                    <th class="center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', 'COM_TIMECLOCK_VALID_TO', 'o.valid_to', $listDirn, $listOrder); ?>
                    </th>
                    <th width="1%" class="nowrap center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', 'JGRID_HEADING_ID', 'o.pto_id', $listDirn, $listOrder); ?>
                    </th>
                </tr>
            </thead>
        ...
        <input type="hidden" name="controller" value="pto" />
