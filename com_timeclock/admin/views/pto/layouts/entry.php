...
$desc       = ($accrual) ? $desc."<br /><strong>".JText::_("COM_TIMECLOCK_AUTOMATIC_ACCRUAL_NO_EDIT")."</strong>" : $desc;
                ...
                <tr class="row<?php echo $displayData["index"] % 2; ?>" sortable-group-id="<?php echo $displayData["data"]->pto_id?>">
                    <td class="center">
                        <?php if ($canEdit || $canEditOwn): ?>
                            <?php echo JHtml::_('grid.id', $displayData["index"], $displayData["data"]->pto_id, false, "id"); ?>
                        <?php endif; ?>
                    </td>
                    <td class="nowrap has-context">
                        <div class="pull-left hasTooltip" title="<?php print $desc; ?>">
                            <?php if ($canEdit || $canEditOwn): ?>
                                <a href="<?php echo JRoute::_('index.php?option=com_timeclock&controller=pto&task=edit&id='.(int) $displayData["data"]->pto_id); ?>">
