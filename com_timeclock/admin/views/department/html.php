...
/**
 * HTML view class for departments
 *
 * @category   Timeclock
 * @package    Timeclock
 * @subpackage com_timeclock
 ...
 * @link       https://dev.hugllc.com/index.php/Project:ComTimeclock
 */
class TimeclockViewsDepartmentHtml extends JViewHtml
{
    ...
    */
    function render()
    {
        ...
        if ($layout == 'edit') {
            ...
            $this->_departmentListView = new JLayoutFile('entry', __DIR__.'/layouts');
    ...
    */
    protected function listToolbar()
    {
        ...
        {
            JToolbarHelper::publish('department.publish', 'JTOOLBAR_PUBLISH', true);
            JToolbarHelper::unpublish('department.unpublish', 'JTOOLBAR_UNPUBLISH', true);
            JToolbarHelper::checkin('department.checkin');
        }
    ...
    */
    ...
    {
        $add = empty($this->data->department_id);
    ...
    protected function getSortFields()
    {
        return array(
            ...
            'c.department_id' => JText::_('JGRID_HEADING_ID'),
    ...
    public function getForm()
    {
        if (!is_object($this->form)) {
            $this->form = JForm::getInstance(
                'department', 
                JPATH_COMPONENT_ADMINISTRATOR."/forms/department.xml"
            );
        }
        return $this->form;
    }
