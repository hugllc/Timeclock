...
<form action="<?php echo JRoute::_('index.php?option=com_timeclock&controller=department'); ?>" method="post" id="adminForm" name="adminForm">
<?php print TimeclockHelpersView::getForm($this->form, $this->data); ?>
    <input type="hidden" name="department_id" value="<?php print $this->data->department_id; ?>" />
    <input type="hidden" name="id" value="<?php print $this->data->department_id; ?>" />
