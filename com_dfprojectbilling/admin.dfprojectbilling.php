...
/**
    $Id: admin.dfprojectbilling.php 403 2006-12-29 21:15:24Z prices $
...
case 'config':
    ...
    HTML_dfprojectbilling::showConfig($option, $df_config);
    break;
case 'configsave':
...
case 'userpref':
	...
	break;
case 'install':
	@require_once("install.dfprojectbilling.php");
	com_install();
default:
    HTML_dfprojectbilling::showAbout();
    break;   
}
