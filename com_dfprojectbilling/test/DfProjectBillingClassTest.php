...
// Call DfProjectBillingClassTest::main() if this source file is executed directly.
if (!defined("PHPUnit_MAIN_METHOD")) {
    define("PHPUnit_MAIN_METHOD", "DfProjectBillingClassTest::main");
}
...
require_once dirname(__FILE__).'/../dfprojectbilling.class.php';
 ...
 * @link       https://dev.hugllc.com/index.php/Project:Timeclock
 */
class DfProjectBillingClassTest extends JoomlaTestCase
{
    /**
    ...
    public static function main() 
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite("DfProjectBillingClassTest");
    ...
    {
        $this->assertSame("#__dfproject_billing", $this->readAttribute($this->o, "_tbl"));
    }
    /**
    ...
    */
    ...
    {
        $_SESSION['DfProjectBilling'] = $cache;
        $this->o->flushCache($type);
        $this->assertSame($expect, $_SESSION['DfProjectBilling']);
    }
    */
...
// Call DfProjectBillingClassTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == "DfProjectBillingClassTest::main") {
    DfProjectBillingClassTest::main();
}
