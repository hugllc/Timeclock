...
class TestCaseDatabase extends \TestCaseDatabase
{
    ...
    protected function getConfig()
    {
        ...
        include_once TEST_PATH."/config.php";
        $return->loadObject(new \JConfigTimeclock);
        return $return;
    }
    /**
     * Loads a file into the database
     *
     * @param array $config The config to set for the component
     *
     * @return null
     *
     * @access protected
     */
    protected function setComponentConfig($config)
    {
        \TimeclockHelpersTimeclock::$params = new \JRegistry($config);
    }
    /**
     * Loads a file into the database
     *
